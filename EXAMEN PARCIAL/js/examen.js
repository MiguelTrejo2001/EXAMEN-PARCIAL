...
function test() {
    ...
    celda_accion.innerHTML="<a href='#' class='icono2' onclick='editar(this)'><i <i class='fa-solid fa-square-pen'></i></a>"
    +" "+"<a href='#' class='icono1' onclick='eliminar(this)'><i <i class='fa-solid fa-delete-left'></i></a>";
